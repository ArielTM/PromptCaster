...
export interface Message {
  type: 'INJECT_PROMPT' | 'INJECT_FILES' | 'GET_RESPONSE' | 'RESPONSE_UPDATE' | 'RESPONSE_COMPLETE' | 'PING' | 'EXECUTE_FILE_INJECTION' | 'EXECUTE_TEXT_INJECTION' | 'GET_CONVERSATION' | 'CLEAR_SERVICE_WORKERS';
  payload?: unknown;
}
